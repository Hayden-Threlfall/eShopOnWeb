...
public class CatalogFilterSpecification
{
    ...
    public List<CatalogItem> GetTestItemCollection()
    {
        return new List<CatalogItem>()
            {
                new CatalogItem(1, 1, "Description", "Name", "Subtitle", 0, "FakePath"),
                new CatalogItem(2, 1, "Description", "Name", "Subtitle", 0, "FakePath"),
                new CatalogItem(3, 1, "Description", "Name", "Subtitle", 0, "FakePath"),
                new CatalogItem(1, 2, "Description", "Name", "Subtitle", 0, "FakePath"),
                new CatalogItem(2, 2, "Description", "Name", "Subtitle", 0, "FakePath"),
            };
    }
}
